...
class ContatoFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'data_inclusao' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => 'current_timestamp()', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'cpf' => 'Lorem ips',
                'data_nascimento' => '2019-10-02',
                'telefone' => 'Lorem ips',
                'cep' => 'Lorem ',
                'endereco' => 'Lorem ipsum dolor sit amet',
                'numero' => 'Lorem ipsum dolor sit amet',
                'data_inclusao' => '2019-10-02 19:46:51',
                'data_alteracao' => '2019-10-02 19:46:51'
            ],
        ];
        parent::init();
    }
